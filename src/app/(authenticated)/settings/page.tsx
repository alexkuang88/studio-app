...
export default function SettingsPage() {
  ...
  const settingDescriptions: Record<string, string> = {
    ...
    salary_v3_premium: "V3高级单价（12h内≥2000万）Ar/100万",
    salary_v3_base: "V3基础单价 Ar/100万",
    salary_v3_threshold: "V3成绩阈值（万）",
    salary_v3_max_hours: "V3时限（小时）",
    salary_v3_start_date: "V3生效日期（YYYY-MM-DD）",
