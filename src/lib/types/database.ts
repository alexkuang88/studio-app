...
// 阶梯工资 v3（按分段 12小时 2000万，2026-09-01 起）
export const DEFAULT_SALARY_V3_PREMIUM = 1000;
export const DEFAULT_SALARY_V3_BASE = 700;
export const DEFAULT_SALARY_V3_THRESHOLD = 2000;
export const DEFAULT_SALARY_V3_MAX_HOURS = 12;
export const SALARY_V3_START_DATE = "2026-09-01";
